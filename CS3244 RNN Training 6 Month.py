...
os.chdir("C:/Users/Ong Jing Long/Downloads/6mo_train_val_data_with_quarters")
                ...
                for batch_size_try in try_batch_size:
                    ...
                    for i in range(k_fold):
                        ...
                        for comp in validating:
                            ...
                            if validating_set.shape[0] < 180:
                                continue
                            validating_set_scaled_x = sc.transform(validating_set.iloc[: , 1:85])
                            validating_set_y = validating_set.iloc[: , 0].values.reshape(-1,1)
                            X_test = []
                            y_test = []
                            for i in range(180, len(validating_set), 180):
                                X_test.append(validating_set_scaled_x[i-180:i, 0:84])
